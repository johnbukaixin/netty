...
public class ExcelUtil {
    ...
    public static void easyExcelExport(JSONArray dataArray,OutputStream os){
        List<EasyExcelStudent> data = dataArray.toJavaList(EasyExcelStudent.class);
        try {
            ExcelWriter writer = new ExcelWriter(os, ExcelTypeEnum.XLSX);
            //写第一个sheet, sheet1  数据全是List<String> 无模型映射关系
            Sheet sheet1 = new Sheet(1, 0, EasyExcelStudent.class);
